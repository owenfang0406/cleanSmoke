        ...
        >
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                ...
                src={require("./SliderImgs/Card1.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
                className={`${styles.fa} ${styles.fa_download}`}
              />
              <AiOutlineLike
                className={`${styles.fa} ${styles.fa_heart}`}
              ></AiOutlineLike>
              <RiShareForwardFill
                className={`${styles.fa} ${styles.fa_share}`}
              ></RiShareForwardFill>
            </div>
          </div>
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card2.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card3.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card4.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card5.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card6.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card7.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card8.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card9.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
          ...
          <div className={styles.cards}>
            ...
            <div className={styles.card_img}>
              <img
                className={styles.imgs}
                src={require("./SliderImgs/Card10.JPG")}
              ></img>
            </div>
            <div className={styles.card_footer}>
              <AiOutlineDownload
